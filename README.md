...
git clone https://github.com/Canibuild-Ops/claude-code-codex-skill ~/.claude/skills/codex
```

Or if you have the [skill-manager](https://github.com/Canibuild-Ops/claude-code-skill-manager) skill:

```bash
# Via /skill-manager
/skill-manager install https://github.com/Canibuild-Ops/claude-code-codex-skill
```
